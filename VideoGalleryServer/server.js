...
function onDbInitialised() {
	...
	// Caching all person info in Redis
	db.execSQL(Person.getListAllPersonsQuery(), function(err,allPersonsList) {
        //RedisCache.cacheCategories(allPersonsList);
		console.log(allPersonsList);
		RedisCache.cacheAllPersons(allPersonsList);
    });
